...
global P Gdry A B C rhoL Kpw nAvp h MWwater MWair dHev CpL CpG rhoG muG dp mp0 vg mdry
...
g = 9.81;
pig = pi;
vs=-(0.33333333333333333333333333333333*g*mp*(rhoG - 1.0*rhoL))/(dp*muG*pig*rhoL);
z=x(5);
